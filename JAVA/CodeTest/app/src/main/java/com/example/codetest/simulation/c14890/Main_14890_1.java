package com.example.codetest.simulation.c14890;
...
public class Main_14890_1 {
    ...
    public static boolean calRow(int row) {
        boolean[] set = new boolean[N]; //경사면 설치 여부
