package com.example.codetest.simulation.c2290;
// https://melthleeth.tistory.com/entry/%EB%B0%B1%EC%A4%80-2290-LCDTest-Java
...
public class Main_2290_1 {
    ...
    public static void fill(int sy, int ey,
                            int sx, int ex, String str) {
